...
神经网络（Neural Networks)是人工智能领域机器学习一部分，就好像人体的神经元、神经系统一样，人工智能的神经网络就是由一个个神经元搭建的系统，多层的神经网络就叫做深度神经网络（Deep Neural Network, **DNN**），也就是深度学习（Deep Learning, **DL**）。它是机器学习最重要的一个分支，也是最流行一种的机器学习算法！
...
![ML&DL](Machine-Learning/ML&DL.png)

* 传统机器学习的特征提取主要依赖人工，针对简单任务简单有效，但是并不通用；
* 深度学习的特征提取是机器自动完成的，因此大家常说深度学习的可解释性很差。
